...
$r1 = mysqli_query($con,"DELETE FROM rank WHERE email='$dfaculty_num' ") or die('Error');
$r2 = mysqli_query($con,"DELETE FROM history WHERE email='$dfaculty_num' ") or die('Error');
$result = mysqli_query($con,"DELETE FROM user WHERE email='$dfaculty_num' ") or die('Error');
